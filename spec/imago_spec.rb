...
describe 'Imago' do
  ...
  it "returns an image response for a valid url" do
    ...
    last_response.header.should == {"Content-Type"=>"image/jpeg", "Cache-Control"=>"max-age=2592000, no-transform, public", "Expires"=>"Thu, 29 Sep 2022 01:22:54 GMT+00:00", "X-Content-Type-Options"=>"nosniff", "Content-Length"=>"8910"}
  end
